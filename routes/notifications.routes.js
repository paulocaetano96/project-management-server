const router = require("express").Router();
    ...
    router.post('/notifications', async (req, res, next) => {
        ...
        try {
            ...
            const notifications = await Notifications.create( { title, description, startTime, endTime, event } )
            //find by id and push the information into the database
            await Event.findByIdAndUpdate(event, { $push: { notifications: notifications._id } })
